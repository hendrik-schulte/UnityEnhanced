...
namespace UE.Math.Editor
{
    ...
    public class Matrix4x4Drawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var mat4x4 = !IsMatrix3x3(property);
            
            float columnWidth;
            if (mat4x4) columnWidth = position.width / 4;
            else columnWidth = position.width / 3;
        ...
        {
            if (IsMatrix3x3(property)) return 48;
            else return 64;
        }

        private bool IsMatrix3x3(SerializedProperty property)
        {
            return property.name == "_mat4x4";
        }
    }
}